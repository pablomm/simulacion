...
objetivos = objetivos = ObjetivosAgrupados(int(n_objetivos/10), espacio, numero_grupos=10, std=5)
organismo = LevyFlightActivo(1,r_sensibilidad=3, posicion=inicial)
