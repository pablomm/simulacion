...
fig.suptitle("Numero de explotados Organismo 2 Etapas - Objetivos agrupados, 1 nucleo")
...
for i, a in enumerate(alphas):
    ...
    for std in std_grupos:
        ...
        # LevyFlight Activo
        organismo = Organismo2Etapas(r_explotacion=r, r_sensibilidad=R, a=a, std=std, maximo=maximo_levy)
